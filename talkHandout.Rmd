...
p2 <- qplot(log(carat), log(price), data = plotdf, shape = cut, alpha = I(0.4)) + 
  theme_bw(base_size = 8) + theme(legend.position = c(0.15, 0.78)) + 
...
\noindent \textbf{Before you submit}, check that you have: \marginnote{Add reference lines and annotate your charts with text. Tell the viewer,
