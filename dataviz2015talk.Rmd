...
opts_chunk$set(fig.width=8, fig.height=5.5, message=FALSE, error=FALSE, 
               ...
               out.width="750px", out.height="550px", fig.align='center')
library(eeptools)
library(ggplot2)
library(ggthemes)
require("hexbin")
...
```{r echo=FALSE, out.width='740px', out.height='300px', fig.align='center'}
plotdf <- df[df$grade < 6, ]
plotdf$mathSS[plotdf$grade == 5 & plotdf$readSS < 400] <- plotdf$mathSS[plotdf$grade == 5 & plotdf$readSS < 400] + 65
plotdf$mathSS[plotdf$grade == 5 & plotdf$readSS > 400 & plotdf$readSS < 500] <- plotdf$mathSS[plotdf$grade == 5 & plotdf$readSS > 400 & plotdf$readSS < 500] + 35
plotdf$mathSS[plotdf$grade == 5 & plotdf$readSS > 550 ] <- plotdf$mathSS[plotdf$grade == 5 & plotdf$readSS > 550] -25
...
```{r plotmeans, echo=FALSE, out.height="450px"}
library(plyr)
...
```{r catplot1, echo=FALSE, out.width='7250px', out.height='420px'}
ggplot(schooldat[schooldat$schid<25 & schooldat$grade==3, ],
       aes(x = reorder(factor(schid), meanR), ymin=meanR - 0.5 * sdR, 
           ymax=meanR + 0.5 * sdR, color=perecon)) + 
